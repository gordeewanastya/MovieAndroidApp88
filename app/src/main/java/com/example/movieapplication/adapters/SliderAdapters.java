...
public class SliderAdapters extends RecyclerView.Adapter<SliderAdapters.SliderViewHolder> {
    ...
    @NotNull
    @Override
    public SliderAdapters.SliderViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull SliderAdapters.SliderViewHolder holder, int position) {
