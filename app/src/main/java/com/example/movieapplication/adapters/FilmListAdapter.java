...
public class FilmListAdapter extends RecyclerView.Adapter<FilmListAdapter.ViewHolder> {
    ...
    @NotNull
    @Override
    public FilmListAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull FilmListAdapter.ViewHolder holder, int position) {
